...
namespace DMM
{
    ...
    public partial class DBDMMEntities2 : DbContext
    {
        public DBDMMEntities2()
            : base("name=DBDMMEntities2")
        {
        }
        ...
        public virtual DbSet<PyamnetCustomer> PyamnetCustomers { get; set; }
